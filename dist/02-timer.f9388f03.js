...
(0, _notiflixDefault.default).Report.info("\uD83D\uDC4B Greeting, my Friend!", "Please, choose a date and click on start", "Okay");
(0, _flatpickrDefault.default)(calendar, {
    ...
    onClose (selectedDates) {
        if (selectedDates[0].getTime() < Date.now()) (0, _notiflixDefault.default).Report.failure("\uD83E\uDD7A Ooops...", 'Please, choose a date in the future and remember: "Knowledge rests not upon truth alone, but upon error also." - Carl Gustav Jung', "Okay");
        else {
            (0, _notiflixDefault.default).Report.success("\uD83E\uDD70 Congratulation! Click on start!", '"Do not try to become a person of success but try to become a person of value." <br/><br/>- Albert Einstein', "Okay");
...
const timer = {
    ...
    start () {
        intervalId = setInterval(()=>{
            ...
            if (delta <= 0) {
                this.stop();
                Report.info("\uD83D\uDC4F Congratulation! Timer stopped!", "Please, if you want to start timer, choose a date and click on start or reload this page", "Okay");
                return;
            }
